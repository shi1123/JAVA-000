package com.szp.geektime.javaclass.week05.mystarter.configuration;

import com.szp.geektime.javaclass.week05.mystarter.pojo.MyClass;
import com.szp.geektime.javaclass.week05.mystarter.pojo.MySchool;
import com.szp.geektime.javaclass.week05.mystarter.pojo.MyStudent;
import com.szp.geektime.javaclass.week05.mystarter.properties.MySchoolProperties;
...
@EnableConfigurationProperties(MySchoolProperties.class)
@ConditionalOnProperty(prefix = "myschool", value = "enabled", havingValue = "true")
@PropertySource("classpath:application.properties")
public class MySchoolAutoConfiguration {
    @Autowired
    private MySchoolProperties schoolProperties;
    ...
    public MySchool mySchool() {
        ...
        for (int i=0; i<studentIds.size(); i++) {
            students.add(new MyStudent(studentIds.get(i), studentNames.get(i)));
        }
